...
import com.bridgex.constants.PentlandauthenticationaddonConstants;



/**
 * This is the extension manager of the Pentlandauthenticationaddon extension.
 */
public class PentlandauthenticationaddonManager extends GeneratedPentlandauthenticationaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PentlandauthenticationaddonManager.class.getName());
	 ...
	 */
	public static PentlandauthenticationaddonManager getInstance()
	{
		return (PentlandauthenticationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PentlandauthenticationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PentlandauthenticationaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PentlandauthenticationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PentlandauthenticationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PentlandauthenticationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
