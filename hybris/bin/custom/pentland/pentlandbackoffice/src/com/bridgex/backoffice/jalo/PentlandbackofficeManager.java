 ...
 */
package com.bridgex.backoffice.jalo;
...
import com.bridgex.backoffice.constants.PentlandbackofficeConstants;
 ...
 */
public class PentlandbackofficeManager extends GeneratedPentlandbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PentlandbackofficeManager.class.getName());
	 ...
	 */
	public static PentlandbackofficeManager getInstance()
	{
		return (PentlandbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PentlandbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PentlandbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PentlandbackofficeManager called.");
		}
	}
