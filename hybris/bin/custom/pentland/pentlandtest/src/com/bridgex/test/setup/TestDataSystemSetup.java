 ...
 */
package com.bridgex.test.setup;
...
import com.bridgex.test.constants.PentlandtestConstants;
import com.bridgex.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PentlandtestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pentlandtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pentlandtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/pentlandtest/import/cstickets.impex");
			...
			importImpexFile(context, "/pentlandtest/import/csquotes.impex");
		}
	}
}
