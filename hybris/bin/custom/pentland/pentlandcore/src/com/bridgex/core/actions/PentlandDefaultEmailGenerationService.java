...
public class PentlandDefaultEmailGenerationService extends DefaultEmailGenerationService {
	...
	public EmailMessageModel generate(final BusinessProcessModel businessProcessModel,
		...
		// This call creates the context to be used for rendering of subject and
		// body templates.
	...
	private EmailMessageModel createEmailMessage(String emailSubject, final String emailBody,
		...
		final String pentlandEmailAddress = getConfigurationService().getConfiguration()
				.getString("pentland.email.addres");
		final String pentlandNameAddress = getConfigurationService().getConfiguration()
				.getString("pentland.name.addres");
