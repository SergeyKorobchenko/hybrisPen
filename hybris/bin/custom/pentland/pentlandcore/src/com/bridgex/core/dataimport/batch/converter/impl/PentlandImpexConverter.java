package com.bridgex.core.dataimport.batch.converter.impl;
...
/**
 * @author Created by ekaterina.agievich@bridge-x.com on 11/23/2017.
 */
public class PentlandImpexConverter implements ImpexConverter {
  ...
  protected void processRow(final Map<Integer, String> row, final Long sequenceId, final StringBuilder builder, final int copyIdx, final int idx, final int endIdx)
  {
    if (endIdx < 0) {
  ...
  protected void processValues(final Map<Integer, String> row, final StringBuilder builder, final int idx, final int endIdx)
  {
    ...
    if (colValue != null) {
      builder.append(StringEscapeUtils.escapeCsv(colValue));
    }
  }
