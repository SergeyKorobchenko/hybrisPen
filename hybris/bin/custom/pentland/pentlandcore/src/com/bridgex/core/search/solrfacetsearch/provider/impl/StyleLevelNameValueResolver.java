 ...
 */
public class StyleLevelNameValueResolver extends AbstractBaseProductValueResolver{
  @Override
                                ...
                                ValueResolverContext<Object, Object> valueResolverContext) throws FieldValueProviderException
  {
    ...
    inputDocument.addField(indexedProperty, baseProductModel.getName(), valueResolverContext.getFieldQualifier());
  }
}
