 ...
 */
package de.hybris.platform.pentlandb2baddon.actions.replenishment;

import static org.hamcrest.core.IsInstanceOf.instanceOf;

import de.hybris.bootstrap.annotations.IntegrationTest;
import de.hybris.platform.pentlandb2baddon.base.ProcessAwareBaseTest;
...
public class ReplenishmentOrderProcessActionIntegrationTest extends ProcessAwareBaseTest
{
	...
	public void beforeTest() throws Exception
	{
		...
		importCsv("/pentlandb2baddon/test/testOrganizations.csv", "utf-8");
		importCsv("/pentlandb2baddon/test/testB2BCommerceCart.csv", "utf-8");
