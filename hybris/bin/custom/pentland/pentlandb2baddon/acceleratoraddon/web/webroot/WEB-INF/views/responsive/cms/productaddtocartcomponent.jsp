        ...
        <div class="row">
            <div class="col-md-6">
                <c:if test="${empty showAddToCart ? true : showAddToCart}">
                    <c:url value="${product.url}" var="productOrderFormUrl"/>
                    <a href="javascript:void(0);" class="btn btn-default btn-block btn-icon js-add-to-cart glyphicon-list-alt js-show-editable-product-grid" >
