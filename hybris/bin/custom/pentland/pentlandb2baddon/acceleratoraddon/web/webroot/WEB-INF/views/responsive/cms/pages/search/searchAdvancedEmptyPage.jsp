...
<%@ taglib prefix="addonProduct" tagdir="/WEB-INF/tags/addons/pentlandb2baddon/responsive/product" %>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
<%@ taglib prefix="cms" uri="http://hybris.com/tld/cmstags" %>
<%@ taglib prefix="nav" tagdir="/WEB-INF/tags/addons/pentlandb2baddon/responsive/nav" %>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
<%@ taglib prefix="formElement" tagdir="/WEB-INF/tags/responsive/formElement" %>
<%@ taglib prefix="addonFormElement" tagdir="/WEB-INF/tags/addons/pentlandb2baddon/responsive/formElement" %>
            ...
            <div class="b-section--full-width">
                <div class="span-24" id="orderFormContainer">
                    ...
                    <div class="advancedSearch">
                        <h1><spring:theme code="search.advanced"/></h1>
