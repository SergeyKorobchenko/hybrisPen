 ...
 */
package com.bridgex.integration.jalo;
...
/**
 * This is the extension manager of the Erpintegration extension.
 */
public class ErpintegrationManager extends GeneratedErpintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ErpintegrationManager.class);
	 ...
	 */
	public static ErpintegrationManager getInstance()
	{
		return (ErpintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ErpintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ErpintegrationManager() // NOPMD 
	{
		LOG.debug("constructor of ErpintegrationManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ErpintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ErpintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
