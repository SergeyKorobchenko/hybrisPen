...
import com.bridgex.integration.service.impl.DefaultErpintegrationService;
 ...
 */
@IntegrationTest
public class DefaultErpintegrationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "erpintegrationPlatformLogo";

		// when
		final String logoUrl = erpintegrationService.getHybrisLogoUrl(logoCode);
