...
/**
 * This is the extension manager of the Pentlandsupportticketingaddon extension.
 */
public class PentlandsupportticketingaddonManager extends GeneratedPentlandsupportticketingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PentlandsupportticketingaddonManager.class.getName());
	 ...
	 */
	public static PentlandsupportticketingaddonManager getInstance()
	{
		return (PentlandsupportticketingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PentlandsupportticketingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PentlandsupportticketingaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PentlandsupportticketingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PentlandsupportticketingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PentlandsupportticketingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
