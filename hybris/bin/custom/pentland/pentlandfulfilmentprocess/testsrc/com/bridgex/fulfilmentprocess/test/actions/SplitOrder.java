 ...
 */
package com.bridgex.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(PentlandfulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PentlandfulfilmentprocessConstants.PARENT_PROCESS);
