...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pentlandb2cstorefront/electronics/en",
						"https://electronics.local:9002/pentlandb2cstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pentlandb2cstorefront/electronics/en",
						"https://electronics.local:9002/pentlandb2cstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pentlandb2cstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/pentlandb2cstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pentlandb2cstorefront/electronics/en",
						"https://electronics.local:9002/pentlandb2cstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pentlandb2cstorefront",
						"https://electronics.local:9002/pentlandb2cstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pentlandb2cstorefront",
						"https://electronics.local:9002/pentlandb2cstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/pentlandb2cstorefront/electronics/en",
						"https://electronics.local:9002/pentlandb2cstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
