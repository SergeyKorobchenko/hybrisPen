                ...
                <c:if test="${empty isMVP1}">
                    <c:if test="${not empty cartData.code}">
                        <span class="cart__id--label">
                            <spring:theme code="basket.page.cartIdShort"/><span
                                class="cart__id">${fn:escapeXml(cartData.code)}</span>
                        </span>
                    </c:if>
                </c:if>
            </h1>
...
<c:if test="${not empty cartData.rootGroups}">
    ...
    <%-- OLD <c:url value="${continueUrl}" var="continueShoppingUrl" scope="session"/>--%>
    <c:url value="https://www.endurasport.com/" var="continueShoppingUrl" scope="session"/>
    ...
    <cart:cartItems isMVP1="${isMVP1}" cartData="${cartData}"/>
