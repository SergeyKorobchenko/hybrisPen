...
<header class="js-mainHeader">
    ...
    <c:if test="${empty isMVP1}">
        ...
        <div class="hidden js-secondaryNavAccount collapse" id="accNavComponentDesktopOne">
            <ul class="nav__links">

            </ul>
        </div>

        <div class="hidden js-secondaryNavCompany collapse" id="accNavComponentDesktopTwo">
            ...
            <div class="container-fluid">
                    ...
                    <div class="mobile__nav__row mobile__nav__row--table">
                        <div class="mobile__nav__row--table-group">
                            <div class="mobile__nav__row--table-row">
                                <div class="mobile__nav__row--table-cell hidden">
                                ...
                                <div class="mobile__nav__row--table-cell hidden mobile__nav__row--seperator">
                                    <ycommerce:testId code="header_search_activation_button">
                                        <button class="mobile__nav__row--btn btn mobile__nav__row--btn-search js-toggle-xs-search hidden"
                                                type="button">
                                ...
                                <cms:pageSlot position="MiniCart" var="cart" element="div"
                                              class="miniCartSlot componentContainer mobile__nav__row--table hidden">
                ...
                <div class="row desktop__nav">
                    <div class="nav__left col-xs-12 col-sm-6">
                        <div class="row">
                            <div class="col-sm-2 hidden mobile-menu">
                    ...
                    <div class="nav__right col-xs-6 col-xs-6 hidden">
