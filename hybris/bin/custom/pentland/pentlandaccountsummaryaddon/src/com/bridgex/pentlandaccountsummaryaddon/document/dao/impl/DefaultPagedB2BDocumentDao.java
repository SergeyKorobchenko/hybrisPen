...
import com.bridgex.pentlandaccountsummaryaddon.document.Range;
...
public class DefaultPagedB2BDocumentDao extends DefaultPagedGenericDao<B2BDocumentModel> implements PagedB2BDocumentDao
{
	...
	private static final Logger LOG = Logger.getLogger(com.bridgex.pentlandaccountsummaryaddon.document.dao.impl.DefaultPagedB2BDocumentDao.class);

	private static final String DEFAULT_SORT_CODE = Config.getString(PentlandaccountsummaryaddonConstants.DEFAULT_SORT_CODE_PROP,
                                                                   "byDocumentDateAsc");
