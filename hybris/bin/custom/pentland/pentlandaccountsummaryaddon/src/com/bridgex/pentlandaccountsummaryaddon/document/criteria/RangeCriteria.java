...
{
	private static final Logger LOG = Logger.getLogger(com.bridgex.pentlandaccountsummaryaddon.document.criteria.RangeCriteria.class);
	...
	{
		super(filterByKey, documentStatus);
		this.startRange = PentlandaccountsummaryaddonUtils.toOptional(startRange);
		this.endRange = PentlandaccountsummaryaddonUtils.toOptional(endRange);
	}
