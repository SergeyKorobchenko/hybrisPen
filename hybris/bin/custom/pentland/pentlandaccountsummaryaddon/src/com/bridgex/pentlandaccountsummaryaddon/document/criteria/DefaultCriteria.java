...
{
	private static final Logger LOG = Logger.getLogger(com.bridgex.pentlandaccountsummaryaddon.document.criteria.DefaultCriteria.class);
	...
	protected final void setB2bDocumentStatus(final String b2bDocumentStatus)
	{
		this.b2bDocumentStatus = StringUtils.isNotBlank(b2bDocumentStatus)
                             && PentlandaccountsummaryaddonUtils.getDocumentStatusList().contains(b2bDocumentStatus) ? Optional.of(DocumentStatus
