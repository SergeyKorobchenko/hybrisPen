 ...
 */
package com.bridgex.pentlandaccountsummaryaddon.jalo;
 ...
 */
public class PentlandaccountsummaryaddonManager extends GeneratedPentlandaccountsummaryaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(com.bridgex.pentlandaccountsummaryaddon.jalo.PentlandaccountsummaryaddonManager.class.getName());
	 ...
	 */
	public static com.bridgex.pentlandaccountsummaryaddon.jalo.PentlandaccountsummaryaddonManager getInstance()
	{
		return (com.bridgex.pentlandaccountsummaryaddon.jalo.PentlandaccountsummaryaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
			PentlandaccountsummaryaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PentlandaccountsummaryaddonManager() // NOPMD
	{
