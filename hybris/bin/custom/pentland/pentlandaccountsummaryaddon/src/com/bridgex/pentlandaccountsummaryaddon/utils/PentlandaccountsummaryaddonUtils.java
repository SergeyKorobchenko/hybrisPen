...
import com.bridgex.pentlandaccountsummaryaddon.document.criteria.*;
import com.bridgex.pentlandaccountsummaryaddon.enums.DocumentStatus;

public class PentlandaccountsummaryaddonUtils
{
	private static final Logger LOG = Logger.getLogger(com.bridgex.pentlandaccountsummaryaddon.utils.PentlandaccountsummaryaddonUtils.class);
	...
	{
		return StringUtils.isNotBlank(s) ? parseDate(s, PentlandaccountsummaryaddonConstants.DATE_FORMAT_MM_DD_YYYY) : Optional.empty();
	}
