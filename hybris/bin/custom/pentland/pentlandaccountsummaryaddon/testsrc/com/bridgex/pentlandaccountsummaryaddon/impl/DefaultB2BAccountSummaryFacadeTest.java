 ...
 */
package com.bridgex.pentlandaccountsummaryaddon.impl;
...
public class DefaultB2BAccountSummaryFacadeTest extends B2BIntegrationTest
{
	...
	public void shouldGetValidResult()
	{
		final Map<String, String> params = QueryParameters.with("currentPage", "0").and("pageSize", "10")
				.and("unit", UNIT_CUSTOM_RETAIL).and("status", PentlandaccountsummaryaddonConstants.SEARCH_STATUS_OPEN)
	...
	public void shouldIncludeStatementDocumentWhenSearchByDocumentNumber()
	{
		...
		final Map<String, String> params = QueryParameters.with("currentPage", "0").and("pageSize", "10")
				.and("unit", UNIT_PRONTO_GOODS).and("status", PentlandaccountsummaryaddonConstants.SEARCH_STATUS_OPEN)
			...
			final String minRange3, final String maxRange3, final String minRange4, final String maxRange4)
	{
		...
		Config.setParameter("pentlandaccountsummaryaddon.daterange.1.start", minRange1);
		Config.setParameter("pentlandaccountsummaryaddon.daterange.1.end", getRange(maxRange1, days));

		Config.setParameter("pentlandaccountsummaryaddon.daterange.2.start", getRange(minRange2, days));
		Config.setParameter("pentlandaccountsummaryaddon.daterange.2.end", getRange(maxRange2, days));

		Config.setParameter("pentlandaccountsummaryaddon.daterange.3.start", getRange(minRange3, days));
		Config.setParameter("pentlandaccountsummaryaddon.daterange.3.end", getRange(maxRange3, days));

		Config.setParameter("pentlandaccountsummaryaddon.daterange.4.start", getRange(minRange4, days));
		Config.setParameter("pentlandaccountsummaryaddon.daterange..end", getRange(maxRange4, days));
	}
