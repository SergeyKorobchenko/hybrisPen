...
public class DateCriteriaValidator implements CriteriaValidator
{
	...
	public boolean isValid(final String startRange, final String endRange, final Model model)
	{
		...
		{
			parsedStartRange = PentlandaccountsummaryaddonUtils.parseDate(startRange, PentlandaccountsummaryaddonConstants.DATE_FORMAT_MM_DD_YYYY);
		...
		{
			parsedEndRange = PentlandaccountsummaryaddonUtils.parseDate(endRange, PentlandaccountsummaryaddonConstants.DATE_FORMAT_MM_DD_YYYY);
