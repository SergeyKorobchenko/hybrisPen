...
{
	protected static final Logger LOG = Logger.getLogger(com.bridgex.pentlandaccountsummaryaddon.controllers.pages.AccountStatusController.class);
	...
	{
		storeCmsPageInModel(model, getContentPageForLabelOrId(PentlandaccountsummaryaddonConstants.ACCOUNT_STATUS_CMS_PAGE));
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId(PentlandaccountsummaryaddonConstants.ACCOUNT_STATUS_CMS_PAGE));
	...
	{
		storeCmsPageInModel(model, getContentPageForLabelOrId(PentlandaccountsummaryaddonConstants.ACCOUNT_STATUS_DETAIL_CMS_PAGE));
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId(PentlandaccountsummaryaddonConstants.ACCOUNT_STATUS_DETAIL_CMS_PAGE));
	...
	public String search(final Model model, @RequestParam(value = "unit") final String unit,
			@RequestParam(value = "page", defaultValue = PentlandaccountsummaryaddonConstants.DEFAULT_PAGE) final Integer currentPage,
			@RequestParam(value = "pageSize", defaultValue = PentlandaccountsummaryaddonConstants.DEFAULT_PAGE_SIZE) final Integer pageSize,
			...
			@RequestParam(value = "status", defaultValue = PentlandaccountsummaryaddonConstants.SEARCH_STATUS_OPEN) final String status,
			@RequestParam(value = "sort", defaultValue = PentlandaccountsummaryaddonConstants.DEFAULT_SORT) final String sort)
			throws CMSItemNotFoundException
	{
		...
		return PentlandaccountsummaryaddonConstants.ACCOUNT_STATUS_DOCUMENTLIST;
	}
