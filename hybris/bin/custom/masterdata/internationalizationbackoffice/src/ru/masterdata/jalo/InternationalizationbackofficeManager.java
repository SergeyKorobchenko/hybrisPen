...
import ru.masterdata.constants.InternationalizationbackofficeConstants;
 ...
 */
public class InternationalizationbackofficeManager extends GeneratedInternationalizationbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InternationalizationbackofficeManager.class.getName());
	 ...
	 */
	public static InternationalizationbackofficeManager getInstance()
	{
		return (InternationalizationbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(InternationalizationbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public InternationalizationbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InternationalizationbackofficeManager called.");
		}
	}
