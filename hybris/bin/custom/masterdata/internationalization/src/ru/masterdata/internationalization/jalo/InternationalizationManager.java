...
package ru.masterdata.internationalization.jalo;
...
import ru.masterdata.internationalization.constants.InternationalizationConstants;
import ru.masterdata.internationalization.jalo.GeneratedInternationalizationManager;



/**
 * This is the extension manager of the Internationalization extension.
 */
public class InternationalizationManager extends GeneratedInternationalizationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InternationalizationManager.class.getName());
	...
	{
		return (InternationalizationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				InternationalizationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public InternationalizationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InternationalizationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of InternationalizationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of InternationalizationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
