...
package ru.masterdata.internationalization.hmc;
 ...
 * @version ExtGen v4.1
 */
public class InternationalizationHMCExtension extends HMCExtension
{
	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "ru.masterdata.internationalization.hmc.locales";
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(InternationalizationHMCExtension.class.getName());
