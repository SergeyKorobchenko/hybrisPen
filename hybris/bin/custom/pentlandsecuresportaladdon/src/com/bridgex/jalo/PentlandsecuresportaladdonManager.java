...
import com.bridgex.constants.PentlandsecuresportaladdonConstants;
...
/**
 * This is the extension manager of the Pentlandsecuresportaladdon extension.
 */
public class PentlandsecuresportaladdonManager extends GeneratedPentlandsecuresportaladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PentlandsecuresportaladdonManager.class.getName());
	 ...
	 */
	public static PentlandsecuresportaladdonManager getInstance()
	{
		return (PentlandsecuresportaladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PentlandsecuresportaladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PentlandsecuresportaladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PentlandsecuresportaladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PentlandsecuresportaladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PentlandsecuresportaladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
