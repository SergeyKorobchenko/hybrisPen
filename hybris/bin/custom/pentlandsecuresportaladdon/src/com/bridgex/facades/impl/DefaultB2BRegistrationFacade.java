 ...
 */
package com.bridgex.facades.impl;
...
import com.bridgex.facades.B2BRegistrationWorkflowFacade;
import com.bridgex.model.B2BRegistrationModel;
...
public class DefaultB2BRegistrationFacade implements B2BRegistrationFacade
{
	 ...
	 * 
	 * @see
	 * com.bridgex.facades.B2BRegistrationFacade#register(com.bridgex
	...
	public void register(final B2BRegistrationData data) throws CustomerAlreadyExistsException
	{
		...
		try
		{
			...
			final WorkflowTemplateModel workflowTemplate = workflowTemplateService
					.getWorkflowTemplateForCode(PentlandsecuresportaladdonConstants.Workflows.REGISTRATION_WORKFLOW);

			if (LOG.isDebugEnabled())
			{
				LOG.debug(String.format("Created WorkflowTemplateModell using name '%s'",
						PentlandsecuresportaladdonConstants.Workflows.REGISTRATION_WORKFLOW));
			}
