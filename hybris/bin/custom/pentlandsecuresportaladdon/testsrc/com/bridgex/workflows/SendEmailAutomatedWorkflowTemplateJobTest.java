...
import com.bridgex.model.B2BRegistrationProcessModel;
import com.bridgex.workflows.actions.SendEmailAutomatedWorkflowTemplateJob;
	...
	public void callPerformWithNoCustomerModel()
	{
		...
		Mockito.when(
				workflowAttachmentService.getAttachmentsForAction(workflowActionModel,
						"com.bridgex.model.B2BRegistrationModel")).thenReturn(b2bRegistrationModelList);
