...
import com.bridgex.services.B2BRegistrationService;
...
public class B2BRegistrationWorkflowIntegrationTest extends WorkflowIntegrationTest
{
	...
	{
		importCsv("/pentlandsecuresportaladdon/test/testCatalog.csv", "UTF-8");
		importCsv("/pentlandsecuresportaladdon/test/testdata.csv", "UTF-8");
